...
#define XML_GET_PREC_FROM_PROP(node, i)                                        \
  value = xmlGetProp(node, (xmlChar *)"precision");                            \
  if (value) {                                                                 \
    i = s2i((char *)value);                                                    \
    xmlFree(value);                                                            \
  } else {                                                                     \
...
#define XML_GET_APPROX_FROM_PROP(node, b)                                      \
  value = xmlGetProp(node, (xmlChar *)"approximate");                          \
  if (value) {                                                                 \
    b = !xmlStrcmp(value, (const xmlChar *)"true");                            \
  } else {                                                                     \
    value = xmlGetProp(node, (xmlChar *)"precise");                            \
    if (value) {                                                               \
      b = xmlStrcmp(value, (const xmlChar *)"true");                           \
    } else {                                                                   \
      b = false;                                                               \
  ...
  if (value)                                                                   \
    xmlFree(value);
#define XML_GET_FALSE_FROM_PROP(node, name, b)                                 \
  value = xmlGetProp(node, (xmlChar *)name);                                   \
  if (value && !xmlStrcmp(value, (const xmlChar *)"false")) {                  \
    b = false;                                                                 \
  } else {                                                                     \
    b = true;                                                                  \
  }                                                                            \
  if (value)                                                                   \
    xmlFree(value);
#define XML_GET_TRUE_FROM_PROP(node, name, b)                                  \
  value = xmlGetProp(node, (xmlChar *)name);                                   \
  if (value && !xmlStrcmp(value, (const xmlChar *)"true")) {                   \
    b = true;                                                                  \
  } else {                                                                     \
    b = false;                                                                 \
  }                                                                            \
  if (value)                                                                   \
    xmlFree(value);
#define XML_GET_BOOL_FROM_PROP(node, name, b)                                  \
  value = xmlGetProp(node, (xmlChar *)name);                                   \
  if (value && !xmlStrcmp(value, (const xmlChar *)"false")) {                  \
    b = false;                                                                 \
  ...
  if (value)                                                                   \
    xmlFree(value);
#define XML_GET_FALSE_FROM_TEXT(node, b)                                       \
  ...
  if (value)                                                                   \
    xmlFree(value);
#define XML_GET_TRUE_FROM_TEXT(node, b)                                        \
  value = xmlNodeListGetString(doc, node->xmlChildrenNode, 1);                 \
  if (value && !xmlStrcmp(value, (const xmlChar *)"true")) {                   \
    b = true;                                                                  \
  } else {                                                                     \
  ...
  if (value)                                                                   \
    xmlFree(value);
#define XML_GET_BOOL_FROM_TEXT(node, b)                                        \
  value = xmlNodeListGetString(doc, node->xmlChildrenNode, 1);                 \
  if (value && !xmlStrcmp(value, (const xmlChar *)"false")) {                  \
    b = false;                                                                 \
  } else if (value && !xmlStrcmp(value, (const xmlChar *)"true")) {            \
  ...
  if (value)                                                                   \
    xmlFree(value);
#define XML_GET_STRING_FROM_PROP(node, name, str)                              \
  value = xmlGetProp(node, (xmlChar *)name);                                   \
  if (value) {                                                                 \
    str = (char *)value;                                                       \
    ...
    str = "";
#define XML_GET_STRING_FROM_TEXT(node, str)                                    \
  value = xmlNodeListGetString(doc, node->xmlChildrenNode, 1);                 \
  if (value) {                                                                 \
    str = (char *)value;                                                       \
    remove_blank_ends(str);                                                    \
    ...
    str = "";
#define XML_DO_FROM_PROP(node, name, action)                                   \
  value = xmlGetProp(node, (xmlChar *)name);                                   \
  if (value)                                                                   \
    action((char *)value);                                                     \
  else                                                                         \
  ...
  if (value)                                                                   \
    xmlFree(value);
#define XML_DO_FROM_TEXT(node, action)                                         \
  value = xmlNodeListGetString(doc, node->xmlChildrenNode, 1);                 \
  if (value) {                                                                 \
    action((char *)value);                                                     \
    xmlFree(value);                                                            \
    ...
    action("");
#define XML_GET_INT_FROM_PROP(node, name, i)                                   \
  value = xmlGetProp(node, (xmlChar *)name);                                   \
  if (value) {                                                                 \
    i = s2i((char *)value);                                                    \
    xmlFree(value);                                                            \
  }
#define XML_GET_INT_FROM_TEXT(node, i)                                         \
  value = xmlNodeListGetString(doc, node->xmlChildrenNode, 1);                 \
  if (value) {                                                                 \
    i = s2i((char *)value);                                                    \
    xmlFree(value);                                                            \
  }
#define XML_GET_LOCALE_STRING_FROM_TEXT(node, str, best, next_best)            \
  value = xmlNodeListGetString(doc, node->xmlChildrenNode, 1);                 \
    ...
    if (!lang) {                                                               \
      ...
      if (locale == (char *)lang) {                                            \
        ...
        if (value) {                                                           \
          ...
          str = "";                                                            \
      } else if (!next_best && strlen((char *)lang) >= 2 &&                    \
                 fulfilled_translation == 0 && lang[0] == localebase[0] &&     \
                 lang[1] == localebase[1]) {                                   \
        next_best = true;                                                      \
        if (value) {                                                           \
          str = (char *)value;                                                 \
          ...
          str = "";                                                            \
      } else if (!next_best && str.empty() && value) {                         \
        str = (char *)value;                                                   \
        remove_blank_ends(str);                                                \
      }                                                                        \
    }                                                                          \
  ...
  if (lang)                                                                    \
    xmlFree(lang);
#define XML_GET_LOCALE_STRING_FROM_TEXT_REQ(node, str, best, next_best)        \
  value = xmlNodeListGetString(doc, node->xmlChildrenNode, 1);                 \
  lang = xmlNodeGetLang(node);                                                 \
  if (!best) {                                                                 \
    if (!lang) {                                                               \
      ...
      if (locale == (char *)lang) {                                            \
        ...
        if (value) {                                                           \
          ...
          str = "";                                                            \
      } else if (!next_best && str.empty() && value && !require_translation) { \
        str = (char *)value;                                                   \
        remove_blank_ends(str);                                                \
      }                                                                        \
    }                                                                          \
...
bool Calculator::loadGlobalDefinitions() {
  bool b = true;
  if (!loadDefinitions(prefixes_xml, false))
    b = false;
  if (!loadDefinitions(currencies_xml, false))
    b = false;
  if (!loadDefinitions(units_xml, false))
    b = false;
  if (!loadDefinitions(functions_xml, false))
    b = false;
  if (!loadDefinitions(datasets_xml, false))
    b = false;
  if (!loadDefinitions(variables_xml, false))
    b = false;
  return b;
}
bool Calculator::loadGlobalDefinitions(string filename) {
  return loadDefinitions(buildPath(getGlobalDefinitionsDir(), filename).c_str(),
                         false);
}
...
bool Calculator::loadGlobalDefinitions() {
  bool b = true;
  if (!loadDefinitions(
          buildPath(getGlobalDefinitionsDir(), "prefixes.xml").c_str(), false))
    b = false;
  if (!loadDefinitions(
          buildPath(getGlobalDefinitionsDir(), "currencies.xml").c_str(),
          false))
    b = false;
  if (!loadDefinitions(
          buildPath(getGlobalDefinitionsDir(), "units.xml").c_str(), false))
    b = false;
  if (!loadDefinitions(
          buildPath(getGlobalDefinitionsDir(), "functions.xml").c_str(), false))
    b = false;
  if (!loadDefinitions(
          buildPath(getGlobalDefinitionsDir(), "datasets.xml").c_str(), false))
    b = false;
  if (!loadDefinitions(
          buildPath(getGlobalDefinitionsDir(), "variables.xml").c_str(), false))
    b = false;
  return b;
}
bool Calculator::loadGlobalDefinitions(string filename) {
...
bool Calculator::loadLocalDefinitions() {
  ...
  if (!dirExists(homedir)) {
    ...
    if (dirExists(homedir)) {
      ...
      if (makeDir(homedir)) {
        ...
        auto f = std::filesystem::path(homedir_old.c_str());
        if (std::filesystem::is_directory(f)) {
          for (auto &i : std::filesystem::directory_iterator(f)) {
            if (!i.is_directory()) {
              if (i.path().filename() != "datasets") {
                eps_old.push_back(i.path().filename().generic_string());
              }
            }
          }
        }
        ...
        #endif
                      if (strcmp(ep_old->d_name, "..") != 0 &&
                          strcmp(ep_old->d_name, ".") != 0 &&
                          strcmp(ep_old->d_name, "datasets") != 0) {
        ...
        for (list<string>::iterator it = eps_old.begin(); it != eps_old.end();
             ++it) {
          move_file(buildPath(homedir_old, *it).c_str(),
  ...
  auto f = std::filesystem::path(homedir.c_str());
  if (std::filesystem::is_directory(f)) {
    for (auto &i : std::filesystem::directory_iterator(f)) {
      if (!i.is_directory()) {
        if (i.path().filename() != "datasets") {
          eps.push_back(i.path().filename().generic_string());
        }
      }
    }
  }
  ...
  for (list<string>::iterator it = eps.begin(); it != eps.end(); ++it) {
    loadDefinitions(buildPath(homedir, *it).c_str(),
                    (*it) == "functions.xml" || (*it) == "variables.xml" ||
                        (*it) == "units.xml" || (*it) == "datasets.xml",
                    true);
  }
  for (size_t i = 0; i < variables.size(); i++) {
    if (!variables[i]->isLocal() && !variables[i]->isActive() &&
        !getActiveExpressionItem(variables[i]))
      variables[i]->setActive(true);
  }
  for (size_t i = 0; i < units.size(); i++) {
    if (!units[i]->isLocal() && !units[i]->isActive() &&
        !getActiveExpressionItem(units[i]))
      units[i]->setActive(true);
  }
  for (size_t i = 0; i < functions.size(); i++) {
    if (!functions[i]->isLocal() && !functions[i]->isActive() &&
        !getActiveExpressionItem(functions[i]))
...
#define X_SET_BEST_NAMES(validation, x)                                        \
  ...
  if (!best_names.empty()) {                                                   \
    str_names = &best_names;                                                   \
  } else if (!nextbest_names.empty()) {                                        \
    str_names = &nextbest_names;                                               \
  } else if (!require_translation || best_title || next_best_title) {          \
    str_names = &default_names;                                                \
  }                                                                            \
  ...
  while (str_names != NULL) {                                                  \
    ...
    if (i2 < names_i) {                                                        \
      ...
      for (; i3 < i2; i3++) {                                                  \
        ...
        case 'a': {                                                            \
          ename.abbreviation = b;                                              \
          b = true;                                                            \
          break;                                                               \
        }                                                                      \
        case 'c': {                                                            \
          ename.case_sensitive = b;                                            \
          b = true;                                                            \
          case_set = true;                                                     \
          break;                                                               \
        }                                                                      \
    ...
    if (names_i == string::npos) {                                             \
      ename.name = str_names->substr(i3, str_names->length() - i3);            \
    } else {                                                                   \
      ename.name = str_names->substr(i3, names_i - i3);                        \
    }                                                                          \
    remove_blank_ends(ename.name);                                             \
    if (!ename.name.empty() &&                                                 \
        validation(ename.name, version_numbers, is_user_defs)) {               \
      if (!case_set) {                                                         \
        ename.case_sensitive =                                                 \
            ename.abbreviation || text_length_is_one(ename.name);              \
      }                                                                        \
      x->addName(ename);                                                       \
    }                                                                          \
    if (names_i == string::npos) {                                             \
...
#define ITEM_SET_BUILTIN_NAMES                                                 \
  for (size_t i = 0; i < 10; i++) {                                            \
    if (ref_names[i].name.empty()) {                                           \
      ...
      size_t i4 =                                                              \
          item->hasName(ref_names[i].name, ref_names[i].case_sensitive);       \
      if (i4 > 0) {                                                            \
...
#define X_SET_REFERENCE_NAMES(validation, x)                                   \
  if (str_names != &default_names && !default_names.empty()) {                 \
    ...
    while (true) {                                                             \
      ...
      if (ename.reference) {                                                   \
        if (names_i == string::npos) {                                         \
          ename.name = default_names.substr(i3, default_names.length() - i3);  \
        } else {                                                               \
          ename.name = default_names.substr(i3, names_i - i3);                 \
        }                                                                      \
        if (!case_set) {                                                       \
          ename.case_sensitive =                                               \
              ename.abbreviation || text_length_is_one(ename.name);            \
...
#define ITEM_SET_REFERENCE_NAMES(validation)                                   \
  X_SET_REFERENCE_NAMES(validation, item)

#define ITEM_READ_NAME(validation)                                             \
  if (!new_names &&                                                            \
      (!xmlStrcmp(child->name, (const xmlChar *)"name") ||                     \
       !xmlStrcmp(child->name, (const xmlChar *)"abbreviation") ||             \
    ...
    if (name_index > 0 && name_index <= 10) {                                  \
      ...
      while (child2 != NULL) {                                                 \
        if ((!best_name[name_index] ||                                         \
             (ref_names[name_index].name.empty() && !locale.empty())) &&       \
          ...
          if (!lang) {                                                         \
            ...
            if (!value2 ||                                                     \
                validation((char *)value2, version_numbers, is_user_defs)) {   \
              if (locale.empty()) {                                            \
                best_name[name_index] = true;                                  \
                if (value2)                                                    \
                  names[name_index].name = (char *)value2;                     \
                else                                                           \
                ...
                if (value2)                                                    \
                  ref_names[name_index].name = (char *)value2;                 \
                else                                                           \
              ...
              if (!value2 ||                                                   \
                ...
                if (value2)                                                    \
                  ...
                  names[name_index].name = "";                                 \
                       ...
                       lang[0] == localebase[0] && lang[1] == localebase[1]) { \
              value2 = xmlNodeListGetString(doc, child2->xmlChildrenNode, 1);  \
              if (!value2 ||                                                   \
                  validation((char *)value2, version_numbers, is_user_defs)) { \
          ...
          ref_names[name_index].avoid_input = names[name_index].avoid_input;   \
                              ...
                              (const xmlChar *)"completion_only")) {           \
          XML_GET_BOOL_FROM_TEXT(child2, names[name_index].completion_only)    \
          ref_names[name_index].completion_only =                              \
              names[name_index].completion_only;                               \
      ...
      if (!case_set) {                                                         \
        ref_names[name_index].case_sensitive =                                 \
            ref_names[name_index].abbreviation ||                              \
            text_length_is_one(ref_names[name_index].name);                    \
        names[name_index].case_sensitive =                                     \
            names[name_index].abbreviation ||                                  \
            text_length_is_one(names[name_index].name);                        \
      }                                                                        \
...
#define ITEM_READ_DTH                                                          \
  if (!xmlStrcmp(child->name, (const xmlChar *)"description")) {               \
    XML_GET_LOCALE_STRING_FROM_TEXT(child, description, best_description,      \
                                    next_best_description)                     \
  } else if (!xmlStrcmp(child->name, (const xmlChar *)"title")) {              \
    XML_GET_LOCALE_STRING_FROM_TEXT_REQ(child, title, best_title,              \
                                        next_best_title)                       \
...
#define ITEM_READ_NAMES                                                        \
  if (new_names &&                                                             \
      ((best_names.empty() && fulfilled_translation != 2) ||                   \
       default_names.empty()) &&                                               \
      !xmlStrcmp(child->name, (const xmlChar *)"names")) {                     \
    ...
    if (!lang) {                                                               \
      ...
      } else if (nextbest_names.empty() && strlen((char *)lang) >= 2 &&        \
                 fulfilled_translation == 0 && lang[0] == localebase[0] &&     \
                 lang[1] == localebase[1]) {                                   \
        if (value) {                                                           \
      ...
      } else if (nextbest_names.empty() && default_names.empty() && value &&   \
                 !require_translation) {                                       \
        nextbest_names = (char *)value;                                        \
        remove_blank_ends(nextbest_names);                                     \
      }                                                                        \
...
#define BUILTIN_NAMES_1                                                        \
  ...
  for (size_t i = 1; i <= item->countNames(); i++) {                           \
    if (item->getName(i).reference) {                                          \
      has_ref_name = false;                                                    \
      for (size_t i2 = 0; i2 < 10; i2++) {                                     \
        if (names[i2].name == item->getName(i).name ||                         \
            ref_names[i2].name == item->getName(i).name) {                     \
          has_ref_name = true;                                                 \
          break;                                                               \
        }                                                                      \
      }                                                                        \
...
#define BUILTIN_UNIT_NAMES_1                                                   \
  ...
  for (size_t i = 1; i <= item->countNames(); i++) {                           \
    if (item->getName(i).reference) {                                          \
      has_ref_name = item->getName(i).name == singular ||                      \
                     item->getName(i).name == plural;                          \
...
int Calculator::loadDefinitions(const char *file_name, bool is_user_defs,
  ...
  string version, stmp, name, uname, type, svalue, sexp, plural, countries,
      singular, category_title, category, description, title, inverse,
      suncertainty, base, argname, usystem;
  bool unc_rel;
  bool best_title = false, next_best_title = false, best_category_title,
       next_best_category_title, best_description, next_best_description;
  bool best_plural, next_best_plural, best_singular, next_best_singular,
      best_argname, next_best_argname, best_countries, next_best_countries;
  ...
  bool active = false, b = false, require_translation = false,
  ...
  bool new_prefix_names = version_numbers[0] > 3 ||
      ...
      if (!xmlStrcmp(cur->name, (const xmlChar *)"activate")) {
        ...
        while (child != NULL) {
          if (!xmlStrcmp(child->name, (const xmlChar *)"type")) {
            ...
            else if (stmp == "boolean")
              ((UnknownVariable *)v)
                  ->assumptions()
                  ->setType(ASSUMPTION_TYPE_BOOLEAN);
        ...
        if (type == "base") {
            ...
            if (!xmlStrcmp(child->name, (const xmlChar *)"system")) {
              ...
              if (!unitNameIsValid(singular, version_numbers, is_user_defs)) {
                singular = "";
                       ...
                       !xmlStrcmp(child->name, (const xmlChar *)"plural") &&
                       !xmlHasProp(child, (xmlChar *)"index")) {
          ...
          if (u->countNames() == 0) {
            ...
            if (!is_user_defs && u->referenceName() == "s")
              u_second = u;
            else if (!is_user_defs && u->referenceName() == "K")
              priv->u_kelvin = u;
          ...
          if (!u) {
            ...
            if (au->countNames() == 0 ||
                (b_remove_cent && au->firstBaseUnit() == u_usd &&
                 au->hasName("cent"))) {
              au->destroy();
              au = NULL;
            } else {
              if (!is_user_defs && au->baseUnit() == u_second) {
                ...
                if (au->referenceName() == "oR")
                  priv->u_rankine = au;
                else if (au->referenceName() == "oC")
                  priv->u_celsius = au;
                else if (au->referenceName() == "oF")
                  priv->u_fahrenheit = au;
              }
        ...
        while (child != NULL) {
          if (!new_prefix_names &&
            ...
            XML_GET_STRING_FROM_TEXT(child, stmp);
                     ...
                     !xmlStrcmp(child->name, (const xmlChar *)"unicode")) {
  ...
  for (size_t i2 = 1;;) {                                                      \
    ...
    if (str.empty() || str[str.length() - 1] == ',') {                         \
      if (i2 == 1 && o->countNames() == 1) {                                   \
        if (save_global) {                                                     \
          xmlNewTextChild(newnode, NULL, (xmlChar *)"_names",                  \
                          (xmlChar *)ename->name.c_str());                     \
        } else {                                                               \
          xmlNewTextChild(newnode, NULL, (xmlChar *)"names",                   \
                          (xmlChar *)ename->name.c_str());                     \
        }                                                                      \
        break;                                                                 \
      }                                                                        \
...
int Calculator::savePrefixes(const char *file_name, bool save_global) {
  ...
  for (size_t i = 0; i < prefixes.size(); i++) {
    ...
    case PREFIX_DECIMAL: {
      ...
      xmlNewTextChild(
          newnode, NULL, (xmlChar *)"exponent",
          (xmlChar *)i2s(((DecimalPrefix *)prefixes[i])->exponent()).c_str());
      break;
    }
    case PREFIX_BINARY: {
      ...
      xmlNewTextChild(
          newnode, NULL, (xmlChar *)"exponent",
          (xmlChar *)i2s(((BinaryPrefix *)prefixes[i])->exponent()).c_str());
      break;
    }
    case PREFIX_NUMBER: {
      xmlNewProp(newnode, (xmlChar *)"type", (xmlChar *)"number");
      xmlNewTextChild(
          newnode, NULL, (xmlChar *)"value",
          (xmlChar *)prefixes[i]->value().print(save_printoptions).c_str());
      break;
    }
    }
  }
...
string Calculator::temporaryCategory() const { return _("Temporary"); }
...
void Calculator::saveVariables(void *xmldoc, bool save_global,
                               bool save_only_temp) {
  ...
  for (size_t i = 0; i < variables.size(); i++) {
    if ((save_global || variables[i]->isLocal() ||
         (!save_only_temp && variables[i]->hasChanged())) &&
        (variables[i]->category() != _("Temporary") &&
         variables[i]->category() != "Temporary") == !save_only_temp &&
        (!save_only_temp || !variables[i]->isBuiltin())) {
      item = &top;
      if (!variables[i]->category().empty()) {
        ...
        while (true) {
          ...
          if (!b) {
            ...
            item->items[item->items.size() - 1].node =
                xmlNewTextChild(item->node, NULL, (xmlChar *)"category", NULL);
            item = &item->items[item->items.size() - 1];
            item->category = cat_sub;
            if (save_global) {
              xmlNewTextChild(item->node, NULL, (xmlChar *)"_title",
                              (xmlChar *)item->category.c_str());
            } else {
              xmlNewTextChild(item->node, NULL, (xmlChar *)"title",
                              (xmlChar *)item->category.c_str());
            }
          }
          if (cat_i == string::npos) {
      ...
      cur = item->node;
      if (!save_global && !variables[i]->isLocal() &&
          variables[i]->hasChanged()) {
        if (variables[i]->isActive()) {
          xmlNewTextChild(cur, NULL, (xmlChar *)"activate",
                          (xmlChar *)variables[i]->referenceName().c_str());
        } else {
          xmlNewTextChild(cur, NULL, (xmlChar *)"deactivate",
                          (xmlChar *)variables[i]->referenceName().c_str());
        }
        ...
        if (variables[i]->isBuiltin()) {
          if (variables[i]->isKnown()) {
            newnode =
                xmlNewTextChild(cur, NULL, (xmlChar *)"builtin_variable", NULL);
          } else {
            newnode =
                xmlNewTextChild(cur, NULL, (xmlChar *)"builtin_unknown", NULL);
          }
          xmlNewProp(newnode, (xmlChar *)"name",
                     (xmlChar *)variables[i]->referenceName().c_str());
        } else {
          if (variables[i]->isKnown()) {
        ...
        if (!variables[i]->isActive())
          xmlNewProp(newnode, (xmlChar *)"active", (xmlChar *)"false");
        if (variables[i]->isHidden())
          xmlNewTextChild(newnode, NULL, (xmlChar *)"hidden",
                          (xmlChar *)"true");
        if (!variables[i]->title(false).empty()) {
          if (save_global) {
            xmlNewTextChild(newnode, NULL, (xmlChar *)"_title",
                            (xmlChar *)variables[i]->title(false).c_str());
          } else {
            xmlNewTextChild(newnode, NULL, (xmlChar *)"title",
                            (xmlChar *)variables[i]->title(false).c_str());
          }
        }
        ...
        if (!variables[i]->description().empty()) {
          ...
          if (save_global) {
            xmlNewTextChild(newnode, NULL, (xmlChar *)"_description",
                            (xmlChar *)str.c_str());
          } else {
            xmlNewTextChild(newnode, NULL, (xmlChar *)"description",
                            (xmlChar *)str.c_str());
          }
        }
        if (!variables[i]->isBuiltin()) {
          if (variables[i]->isKnown()) {
            ...
            if (((KnownVariable *)variables[i])->isExpression()) {
              newnode2 =
                  xmlNewTextChild(newnode, NULL, (xmlChar *)"value",
                                  (xmlChar *)((KnownVariable *)variables[i])
                                      ->expression()
                                      .c_str());
              bool unc_rel = false;
              if (!((KnownVariable *)variables[i])
                       ->uncertainty(&unc_rel)
                       .empty())
                xmlNewProp(newnode2,
                           (xmlChar *)(unc_rel ? "relative_uncertainty"
                                               : "uncertainty"),
                           (xmlChar *)((KnownVariable *)variables[i])
                               ->uncertainty()
                               .c_str());
              if (!((KnownVariable *)variables[i])->unit().empty())
                xmlNewProp(
                    newnode2, (xmlChar *)"unit",
                    (xmlChar *)((KnownVariable *)variables[i])->unit().c_str());
            } else {
              newnode2 =
                  xmlNewTextChild(newnode, NULL, (xmlChar *)"value",
                                  (xmlChar *)((KnownVariable *)variables[i])
                                      ->get()
                                      .print(save_printoptions)
                                      .c_str());
            }
            save_printoptions.is_approximate = NULL;
            if (variables[i]->isApproximate() || is_approx)
              xmlNewProp(newnode2, (xmlChar *)"approximate", (xmlChar *)"true");
            if (variables[i]->precision() >= 0)
              xmlNewProp(newnode2, (xmlChar *)"precision",
                         (xmlChar *)i2s(variables[i]->precision()).c_str());
          } else {
            if (((UnknownVariable *)variables[i])->assumptions()) {
              switch (
                  ((UnknownVariable *)variables[i])->assumptions()->type()) {
              case ASSUMPTION_TYPE_INTEGER: {
                newnode2 = xmlNewTextChild(newnode, NULL, (xmlChar *)"type",
                                           (xmlChar *)"integer");
                break;
              }
              ...
              if (((UnknownVariable *)variables[i])->assumptions()->type() !=
                  ASSUMPTION_TYPE_BOOLEAN) {
                switch (
                    ((UnknownVariable *)variables[i])->assumptions()->sign()) {
...
void Calculator::saveUnits(void *xmldoc, bool save_global,
                           bool save_only_temp) {
  xmlDocPtr doc = (xmlDocPtr)xmldoc;
  string str;
  ...
  for (size_t i = 0; i < units.size(); i++) {
    u = units[i];
    if ((save_global || u->isLocal() || (!save_only_temp && u->hasChanged())) &&
        (u->category() != _("Temporary") && u->category() != "Temporary") ==
            !save_only_temp &&
        (!save_only_temp || !units[i]->isBuiltin())) {
      item = &top;
      if (!u->category().empty()) {
        if (save_only_temp)
          cat = "Temporary";
      ...
      if (!save_global && !u->isLocal() && u->hasChanged()) {
        ...
        if (u->isHidden())
          xmlNewTextChild(newnode, NULL, (xmlChar *)"hidden",
                          (xmlChar *)"true");
        if (!u->system().empty()) {
          xmlNewTextChild(newnode, NULL, (xmlChar *)"system",
                          (xmlChar *)u->system().c_str());
        }
        if ((u->isSIUnit() && (!u->useWithPrefixesByDefault() ||
                               u->maxPreferredPrefix() != INT_MAX ||
                               u->minPreferredPrefix() != INT_MIN)) ||
            (u->useWithPrefixesByDefault() && !u->isSIUnit()) ||
            u->defaultPrefix() != 0) {
          newnode2 = xmlNewTextChild(
              newnode, NULL, (xmlChar *)"use_with_prefixes",
              u->useWithPrefixesByDefault() ? (xmlChar *)"true"
                                            : (xmlChar *)"false");
          if (u->minPreferredPrefix() != INT_MIN)
            xmlNewProp(newnode2, (xmlChar *)"min",
                       (xmlChar *)i2s(u->minPreferredPrefix()).c_str());
          if (u->maxPreferredPrefix() != INT_MAX)
            xmlNewProp(newnode2, (xmlChar *)"max",
                       (xmlChar *)i2s(u->maxPreferredPrefix()).c_str());
          if (u->defaultPrefix() != 0)
            xmlNewProp(newnode2, (xmlChar *)"default",
                       (xmlChar *)i2s(u->defaultPrefix()).c_str());
        }
        if (!u->title(false).empty()) {
          if (save_global) {
            xmlNewTextChild(newnode, NULL, (xmlChar *)"_title",
                            (xmlChar *)u->title(false).c_str());
          } else {
            xmlNewTextChild(newnode, NULL, (xmlChar *)"title",
                            (xmlChar *)u->title(false).c_str());
          }
        ...
        if (!u->isBuiltin()) {
          if (u->subtype() == SUBTYPE_COMPOSITE_UNIT) {
            for (size_t i2 = 1; i2 <= cu->countUnits(); i2++) {
              newnode2 =
                  xmlNewTextChild(newnode, NULL, (xmlChar *)"part", NULL);
              int exp = 1;
              Prefix *p = NULL;
              Unit *u = cu->get(i2, &exp, &p);
              xmlNewTextChild(newnode2, NULL, (xmlChar *)"unit",
                              (xmlChar *)u->referenceName().c_str());
              if (p) {
                switch (p->type()) {
                case PREFIX_DECIMAL: {
                  xmlNewTextChild(
                      newnode2, NULL, (xmlChar *)"prefix",
                      (xmlChar *)i2s(((DecimalPrefix *)p)->exponent()).c_str());
                  break;
                }
                case PREFIX_BINARY: {
                  newnode3 = xmlNewTextChild(
                      newnode2, NULL, (xmlChar *)"prefix",
                      (xmlChar *)i2s(((BinaryPrefix *)p)->exponent()).c_str());
                ...
                case PREFIX_NUMBER: {
                  newnode3 = xmlNewTextChild(
                      newnode2, NULL, (xmlChar *)"prefix",
                      (xmlChar *)p->value().print(save_printoptions).c_str());
                  xmlNewProp(newnode3, (xmlChar *)"type", (xmlChar *)"number");
                  break;
                }
                }
              }
              xmlNewTextChild(newnode2, NULL, (xmlChar *)"exponent",
                              (xmlChar *)i2s(exp).c_str());
            }
          }
          if (u->subtype() == SUBTYPE_ALIAS_UNIT) {
            newnode2 = xmlNewTextChild(newnode, NULL, (xmlChar *)"base", NULL);
            xmlNewTextChild(
                newnode2, NULL, (xmlChar *)"unit",
                (xmlChar *)au->firstBaseUnit()->referenceName().c_str());
            newnode3 = xmlNewTextChild(newnode2, NULL, (xmlChar *)"relation",
                                       (xmlChar *)au->expression().c_str());
            if (au->isApproximate())
              xmlNewProp(newnode3, (xmlChar *)"approximate", (xmlChar *)"true");
            if (au->precision() >= 0)
              xmlNewProp(newnode3, (xmlChar *)"precision",
                         (xmlChar *)i2s(u->precision()).c_str());
            bool unc_rel = false;
            if (!au->uncertainty(&unc_rel).empty())
              xmlNewProp(
                  newnode3,
                  (xmlChar *)(unc_rel ? "relative_uncertainty" : "uncertainty"),
                  (xmlChar *)au->uncertainty().c_str());
            if (!au->inverseExpression().empty()) {
              xmlNewTextChild(newnode2, NULL, (xmlChar *)"inverse_relation",
                              (xmlChar *)au->inverseExpression().c_str());
            }
            xmlNewTextChild(newnode2, NULL, (xmlChar *)"exponent",
                            (xmlChar *)i2s(au->firstBaseExponent()).c_str());
            if (au->mixWithBase() > 0) {
              newnode3 =
                  xmlNewTextChild(newnode2, NULL, (xmlChar *)"mix",
                                  (xmlChar *)i2s(au->mixWithBase()).c_str());
              if (au->mixWithBaseMinimum() > 1)
                xmlNewProp(newnode3, (xmlChar *)"min",
                           (xmlChar *)i2s(au->mixWithBaseMinimum()).c_str());
            }
          }
        }
      }
...
void Calculator::saveFunctions(void *xmldoc, bool save_global,
                               bool save_only_temp) {
  xmlDocPtr doc = (xmlDocPtr)xmldoc;
  xmlNodePtr cur, newnode, newnode2;
  const ExpressionName *ename;
  ...
  string str;
  for (size_t i = 0; i < functions.size(); i++) {
    if (functions[i]->subtype() != SUBTYPE_DATA_SET &&
        (save_global || functions[i]->isLocal() ||
         (!save_only_temp && functions[i]->hasChanged())) &&
        (functions[i]->category() != _("Temporary") &&
         functions[i]->category() != "Temporary") == !save_only_temp &&
        (!save_only_temp || !functions[i]->isBuiltin())) {
      item = &top;
      ...
      if (!save_global && !functions[i]->isLocal() &&
          functions[i]->hasChanged()) {
        if (functions[i]->isActive()) {
          xmlNewTextChild(cur, NULL, (xmlChar *)"activate",
                          (xmlChar *)functions[i]->referenceName().c_str());
        } else {
          xmlNewTextChild(cur, NULL, (xmlChar *)"deactivate",
                          (xmlChar *)functions[i]->referenceName().c_str());
        }
        ...
        if (functions[i]->isBuiltin()) {
          newnode =
              xmlNewTextChild(cur, NULL, (xmlChar *)"builtin_function", NULL);
          xmlNewProp(newnode, (xmlChar *)"name",
                     (xmlChar *)functions[i]->referenceName().c_str());
        } else {
        ...
        if (!functions[i]->isActive())
          xmlNewProp(newnode, (xmlChar *)"active", (xmlChar *)"false");
        if (functions[i]->isHidden())
          xmlNewTextChild(newnode, NULL, (xmlChar *)"hidden",
                          (xmlChar *)"true");
        if (!functions[i]->title(false).empty()) {
          if (save_global) {
            xmlNewTextChild(newnode, NULL, (xmlChar *)"_title",
                            (xmlChar *)functions[i]->title(false).c_str());
          } else {
            xmlNewTextChild(newnode, NULL, (xmlChar *)"title",
                            (xmlChar *)functions[i]->title(false).c_str());
          }
        ...
        if (!functions[i]->example(true).empty())
          newnode2 =
              xmlNewTextChild(newnode, NULL, (xmlChar *)"example",
                              (xmlChar *)functions[i]->example(true).c_str());
        if (functions[i]->isBuiltin()) {
          cur = newnode;
          for (size_t i2 = 1; i2 <= functions[i]->lastArgumentDefinitionIndex();
               i2++) {
            ...
            if (arg && !arg->name().empty()) {
              ...
              if (save_global) {
                xmlNewTextChild(newnode, NULL, (xmlChar *)"_title",
                                (xmlChar *)arg->name().c_str());
              } else {
                xmlNewTextChild(newnode, NULL, (xmlChar *)"title",
                                (xmlChar *)arg->name().c_str());
              }
              xmlNewProp(newnode, (xmlChar *)"index",
                         (xmlChar *)i2s(i2).c_str());
            }
          }
        } else {
          for (size_t i2 = 1;
               i2 <= ((UserFunction *)functions[i])->countSubfunctions();
               i2++) {
            newnode2 = xmlNewTextChild(newnode, NULL, (xmlChar *)"subfunction",
                                       (xmlChar *)((UserFunction *)functions[i])
                                           ->getSubfunction(i2)
                                           .c_str());
            if (((UserFunction *)functions[i])->subfunctionPrecalculated(i2))
              xmlNewProp(newnode2, (xmlChar *)"precalculate",
                         (xmlChar *)"true");
            else
              xmlNewProp(newnode2, (xmlChar *)"precalculate",
                         (xmlChar *)"false");
          ...
          newnode2 = xmlNewTextChild(
              newnode, NULL, (xmlChar *)"expression",
              (xmlChar *)((UserFunction *)functions[i])->formula().c_str());
          if (functions[i]->isApproximate())
            xmlNewProp(newnode2, (xmlChar *)"approximate", (xmlChar *)"true");
          if (functions[i]->precision() >= 0)
            xmlNewProp(newnode2, (xmlChar *)"precision",
                       (xmlChar *)i2s(functions[i]->precision()).c_str());
          if (!functions[i]->condition().empty()) {
            xmlNewTextChild(newnode, NULL, (xmlChar *)"condition",
                            (xmlChar *)functions[i]->condition().c_str());
          }
          cur = newnode;
          for (size_t i2 = 1; i2 <= functions[i]->lastArgumentDefinitionIndex();
               i2++) {
            ...
            if (arg) {
              ...
              case ARGUMENT_TYPE_TEXT: {
                xmlNewProp(newnode, (xmlChar *)"type", (xmlChar *)"text");
                break;
              }
              case ARGUMENT_TYPE_SYMBOLIC: {
                xmlNewProp(newnode, (xmlChar *)"type", (xmlChar *)"symbol");
                break;
              }
              case ARGUMENT_TYPE_DATE: {
                xmlNewProp(newnode, (xmlChar *)"type", (xmlChar *)"date");
                break;
              }
              case ARGUMENT_TYPE_INTEGER: {
                xmlNewProp(newnode, (xmlChar *)"type", (xmlChar *)"integer");
                break;
              }
              ...
              case ARGUMENT_TYPE_VECTOR: {
                xmlNewProp(newnode, (xmlChar *)"type", (xmlChar *)"vector");
                break;
              }
              case ARGUMENT_TYPE_MATRIX: {
                xmlNewProp(newnode, (xmlChar *)"type", (xmlChar *)"matrix");
                break;
              }
              case ARGUMENT_TYPE_BOOLEAN: {
                xmlNewProp(newnode, (xmlChar *)"type", (xmlChar *)"boolean");
                break;
              }
              case ARGUMENT_TYPE_FUNCTION: {
                xmlNewProp(newnode, (xmlChar *)"type", (xmlChar *)"function");
                break;
              }
              case ARGUMENT_TYPE_UNIT: {
                xmlNewProp(newnode, (xmlChar *)"type", (xmlChar *)"unit");
                break;
              }
              case ARGUMENT_TYPE_VARIABLE: {
                xmlNewProp(newnode, (xmlChar *)"type", (xmlChar *)"variable");
                break;
              }
              case ARGUMENT_TYPE_EXPRESSION_ITEM: {
                xmlNewProp(newnode, (xmlChar *)"type", (xmlChar *)"object");
                break;
              }
              case ARGUMENT_TYPE_ANGLE: {
                xmlNewProp(newnode, (xmlChar *)"type", (xmlChar *)"angle");
                break;
              }
              case ARGUMENT_TYPE_DATA_OBJECT: {
                xmlNewProp(newnode, (xmlChar *)"type",
                           (xmlChar *)"data-object");
                break;
              }
              case ARGUMENT_TYPE_DATA_PROPERTY: {
                xmlNewProp(newnode, (xmlChar *)"type",
                           (xmlChar *)"data-property");
                break;
              }
              default: {
                xmlNewProp(newnode, (xmlChar *)"type", (xmlChar *)"free");
              }
              }
              xmlNewProp(newnode, (xmlChar *)"index",
                         (xmlChar *)i2s(i2).c_str());
              bool default_hv =
                  arg->tests() && (arg->type() == ARGUMENT_TYPE_NUMBER ||
                                   arg->type() == ARGUMENT_TYPE_INTEGER);
              if (!default_hv && arg->handlesVector()) {
                xmlNewTextChild(newnode, NULL, (xmlChar *)"handle_vector",
                                (xmlChar *)"true");
              ...
              if (!arg->tests()) {
                xmlNewTextChild(newnode, NULL, (xmlChar *)"test",
                                (xmlChar *)"false");
              }
              if (!arg->alerts()) {
                xmlNewTextChild(newnode, NULL, (xmlChar *)"alert",
                                (xmlChar *)"false");
              }
              if (arg->zeroForbidden()) {
                xmlNewTextChild(newnode, NULL, (xmlChar *)"zero_forbidden",
                                (xmlChar *)"true");
              }
              if (arg->matrixAllowed()) {
                xmlNewTextChild(newnode, NULL, (xmlChar *)"matrix_allowed",
                                (xmlChar *)"true");
              }
              switch (arg->type()) {
              case ARGUMENT_TYPE_INTEGER: {
                ...
                if (iarg->min()) {
                  xmlNewTextChild(
                      newnode, NULL, (xmlChar *)"min",
                      (xmlChar *)iarg->min()->print(save_printoptions).c_str());
                }
                if (iarg->max()) {
                  xmlNewTextChild(
                      newnode, NULL, (xmlChar *)"max",
                      (xmlChar *)iarg->max()->print(save_printoptions).c_str());
                }
                break;
              }
              case ARGUMENT_TYPE_NUMBER: {
                ...
                if (farg->min()) {
                  newnode2 = xmlNewTextChild(
                      newnode, NULL, (xmlChar *)"min",
                      (xmlChar *)farg->min()->print(save_printoptions).c_str());
                  if (farg->includeEqualsMin()) {
                    xmlNewProp(newnode2, (xmlChar *)"include_equals",
                               (xmlChar *)"true");
                  } else {
                    xmlNewProp(newnode2, (xmlChar *)"include_equals",
                               (xmlChar *)"false");
                ...
                if (farg->max()) {
                  newnode2 = xmlNewTextChild(
                      newnode, NULL, (xmlChar *)"max",
                      (xmlChar *)farg->max()->print(save_printoptions).c_str());
                ...
                if (!farg->complexAllowed()) {
                  xmlNewTextChild(newnode, NULL, (xmlChar *)"complex_allowed",
                                  (xmlChar *)"false");
                }
                break;
              }
              ...
              if (!arg->getCustomCondition().empty()) {
                xmlNewTextChild(newnode, NULL, (xmlChar *)"condition",
                                (xmlChar *)arg->getCustomCondition().c_str());
              }
            }
          }
        }
    ...
    if (functions[i]->subtype() == SUBTYPE_DATA_SET &&
      ...
      if (save_global || ds->isLocal() || ds->hasChanged()) {
        if (save_global || ds->isLocal()) {
          ...
          newnode =
              xmlNewTextChild(cur, NULL, (xmlChar *)"builtin_dataset", NULL);
          xmlNewProp(newnode, (xmlChar *)"name",
                     (xmlChar *)ds->referenceName().c_str());
        }
        if (!ds->isActive())
          xmlNewProp(newnode, (xmlChar *)"active", (xmlChar *)"false");
        if (ds->isHidden())
        ...
        if ((save_global || ds->isLocal()) && !ds->defaultDataFile().empty()) {
          xmlNewTextChild(newnode, NULL, (xmlChar *)"datafile",
                          (xmlChar *)ds->defaultDataFile().c_str());
        }
        SAVE_NAMES(ds)
        ...
        if ((save_global || ds->isLocal()) && !ds->copyright().empty()) {
          if (save_global) {
            xmlNewTextChild(newnode, NULL, (xmlChar *)"_copyright",
                            (xmlChar *)ds->copyright().c_str());
          } else {
            xmlNewTextChild(newnode, NULL, (xmlChar *)"copyright",
                            (xmlChar *)ds->copyright().c_str());
          }
        }
        arg = ds->getArgumentDefinition(1);
        if (arg &&
            ((!save_global && !ds->isLocal()) || arg->name() != _("Object"))) {
          newnode2 = xmlNewTextChild(newnode, NULL,
                                     (xmlChar *)"object_argument", NULL);
          if (save_global) {
            xmlNewTextChild(newnode2, NULL, (xmlChar *)"_title",
                            (xmlChar *)arg->name().c_str());
          } else {
            xmlNewTextChild(newnode2, NULL, (xmlChar *)"title",
                            (xmlChar *)arg->name().c_str());
          }
        }
        arg = ds->getArgumentDefinition(2);
        if (arg && ((!save_global && !ds->isLocal()) ||
                    arg->name() != _("Property"))) {
          newnode2 = xmlNewTextChild(newnode, NULL,
                                     (xmlChar *)"property_argument", NULL);
          if (save_global) {
            xmlNewTextChild(newnode2, NULL, (xmlChar *)"_title",
                            (xmlChar *)arg->name().c_str());
          } else {
        ...
        if ((!save_global && !ds->isLocal()) ||
            ds->getDefaultValue(2) != _("info")) {
          xmlNewTextChild(newnode, NULL, (xmlChar *)"default_property",
                          (xmlChar *)ds->getDefaultValue(2).c_str());
        }
        DataPropertyIter it;
        ...
        while (dp) {
          if (save_global || ds->isLocal() || dp->isUserModified()) {
            newnode2 =
                xmlNewTextChild(newnode, NULL, (xmlChar *)"property", NULL);
            if (!dp->title(false).empty()) {
              if (save_global) {
                xmlNewTextChild(newnode2, NULL, (xmlChar *)"_title",
                                (xmlChar *)dp->title().c_str());
              } else {
                xmlNewTextChild(newnode2, NULL, (xmlChar *)"title",
                                (xmlChar *)dp->title().c_str());
              }
            ...
            case PROPERTY_STRING: {
              xmlNewTextChild(newnode2, NULL, (xmlChar *)"type",
                              (xmlChar *)"text");
              break;
            }
            ...
            if (dp->isHidden()) {
              xmlNewTextChild(newnode2, NULL, (xmlChar *)"hidden",
                              (xmlChar *)"true");
            }
            if (dp->isKey()) {
              xmlNewTextChild(newnode2, NULL, (xmlChar *)"key",
                              (xmlChar *)"true");
            }
            if (dp->isApproximate()) {
              xmlNewTextChild(newnode2, NULL, (xmlChar *)"approximate",
                              (xmlChar *)"true");
            }
            if (dp->usesBrackets()) {
              xmlNewTextChild(newnode2, NULL, (xmlChar *)"brackets",
                              (xmlChar *)"true");
            }
            if (dp->isCaseSensitive()) {
              xmlNewTextChild(newnode2, NULL, (xmlChar *)"case_sensitive",
                              (xmlChar *)"true");
            }
            if (!dp->getUnitString().empty()) {
              xmlNewTextChild(newnode2, NULL, (xmlChar *)"unit",
                              (xmlChar *)dp->getUnitString().c_str());
            }
            str = "";
            for (size_t i2 = 1;;) {
              if (dp->nameIsReference(i2)) {
                str += 'r';
              }
              if (str.empty() || str[str.length() - 1] == ',') {
                if (i2 == 1 && dp->countNames() == 1) {
                  if (save_global) {
                    xmlNewTextChild(newnode2, NULL, (xmlChar *)"_names",
                                    (xmlChar *)dp->getName(i2).c_str());
                  } else {
                    xmlNewTextChild(newnode2, NULL, (xmlChar *)"names",
                                    (xmlChar *)dp->getName(i2).c_str());
                  }
                  break;
                }
            ...
            if (!dp->description().empty()) {
              str = dp->description();
              if (save_global) {
                xmlNewTextChild(newnode2, NULL, (xmlChar *)"_description",
                                (xmlChar *)str.c_str());
              } else {
                xmlNewTextChild(newnode2, NULL, (xmlChar *)"description",
                                (xmlChar *)str.c_str());
              }
            }
          }
...
bool Calculator::importCSV(MathStructure &mstruct, const char *file_name,
                           int first_row, string delimiter,
...
bool Calculator::loadExchangeRates() {
    ...
    while ((cfile.rdstate() & std::ifstream::eofbit) == 0) {
      ...
      if (i != string::npos && i > 0 && i < sbuffer.length() - 1) {
        ...
        if (!s1.empty() && !s2.empty()) {
          ...
          if (!u2) {
            u2 = addUnit(new AliasUnit(_("Currency"), s2, "", "", "", u_euro,
                                       "1", 1, "", false, true));
          }
          if (u2 && u2->isCurrency()) {
            ...
            if (!u1) {
              u1 = addUnit(
                  new AliasUnit(_("Currency"), s1, "", "", "", u2,
                                nr1 == "1" ? nr2 : nr2 + string("/") + nr1, 1,
                                "", false, true));
              u1->setApproximate();
              u1->setPrecision(-2);
              u1->setChanged(false);
              ...
              if (u1 == u_euro) {
                ...
                ((AliasUnit *)u2)
                    ->setExpression(nr2 == "1" ? nr1 : nr1 + string("/") + nr2);
                u2->setApproximate();
                u2->setPrecision(-2);
                u2->setChanged(false);
                cunits[u2] = true;
                ...
                ((AliasUnit *)u1)
                    ->setExpression(nr1 == "1" ? nr2 : nr2 + string("/") + nr1);
                u1->setApproximate();
                u1->setPrecision(-2);
                u1->setChanged(false);
                cunits[u1] = true;
    ...
    if (!xmlStrcmp(cur->name, (const xmlChar *)"Cube")) {
      if (global_file && sdate.empty()) {
        ...
        if (qdate.set(sdate)) {
          ...
          if (exchange_rates_time[0] > exchange_rates_check_time[0])
            exchange_rates_check_time[0] = exchange_rates_time[0];
        } else {
          sdate.clear();
        }
      }
  ...
  while (i != string::npos) {
    ...
    if (currency.length() == 3 &&
        (currency_defs.empty() ||
         currency_defs.find(builtin_str + currency) != string::npos) &&
        currency != "BYR") {
      if (!byn_found && currency == "BYN")
        byn_found = true;
      u = getUnit(currency);
      if (!u ||
          (u->subtype() == SUBTYPE_ALIAS_UNIT && ((AliasUnit *)u)->isHidden() &&
           u->isBuiltin() && !u->isLocal())) {
        if (json_variant == 1 || json_variant == 2) {
    ...
    if (file3.is_open()) {
      ...
      if (i != string::npos) {
        ...
        if (i != string::npos) {
          ...
          ((AliasUnit *)priv->u_byn)
              ->setExpression(string("1/") + sbuffer.substr(i, i2 - i));
...
string Calculator::getExchangeRatesFileName(int index) {
  ...
  case 4: {
    return buildPath(getLocalDataDir(), "nrby.json");
  }
  default: {
  }
  }
...
time_t Calculator::getExchangeRatesTime(int index) {
  ...
  if (index < 1) {
    ...
    for (int i = 1; i < 4; i++) {
      if (i > 2 && priv->exchange_rates_time2[i - 3] < extime)
        extime = priv->exchange_rates_time2[i - 3];
      else if (i <= 2 && exchange_rates_time[i] < extime)
        extime = exchange_rates_time[i];
    }
    return extime;
  }
  index--;
  if (index == 5) {
    if (exchange_rates_time[2] < priv->exchange_rates_time2[0])
      return exchange_rates_time[2];
    return priv->exchange_rates_time2[0];
  }
  if (index > 2)
    return priv->exchange_rates_time2[index - 3];
...
string Calculator::getExchangeRatesUrl(int index) {
  ...
  case 3: {
    if (priv->exchange_rates_url3 == 1) {
      ...
      return "https://cdn.jsdelivr.net/gh/fawazahmed0/currency-api@1/latest/"
             "currencies/eur.json";
    }
  }
  case 4: {
    return "https://www.nbrb.by/api/exrates/rates/eur?parammode=2";
  }
  default: {
  }
  }
...
bool Calculator::fetchExchangeRates(int timeout, string) {
  return fetchExchangeRates(timeout);
}
...
#define FER_ERROR(x, y, z, u)                                                  \
  if (n <= 0 && strlen(z) > 0) {                                               \
    ...
    int n1 = 0;                                                                \
    if (strlen(u) > 0)                                                         \
      n1 = snprintf(buffer, 10000,                                             \
                    _("Failed to download exchange rates (%s) from %s: %s."),  \
                    u, x, y);                                                  \
    else                                                                       \
      n1 =                                                                     \
          snprintf(buffer, 10000,                                              \
                   _("Failed to download exchange rates from %s: %s."), x, y); \
    if (n1 > 0 && n1 < 9000) {                                                 \
      buffer[n1] = ' ';                                                        \
      n1++;                                                                    \
      int n2 = snprintf(                                                       \
          buffer + (sizeof(char) * n1), 10000 - n1,                            \
          _("Exchange rates were successfully downloaded from %s."), z);       \
      if (n2 > 0 && n2 + n1 < 10000) {                                         \
    ...
    if (strlen(u) > 0)                                                         \
      error(true, _("Failed to download exchange rates (%s) from %s: %s."), u, \
            x, y, NULL);                                                       \
    else                                                                       \
      error(true, _("Failed to download exchange rates from %s: %s."), x, y,   \
            NULL);                                                             \
  }

#define FETCH_FAIL_CLEANUP                                                     \
  curl_easy_cleanup(curl);                                                     \
  curl_global_cleanup();                                                       \
  time(&exchange_rates_check_time[0]);                                         \
  time(&exchange_rates_check_time[1]);                                         \
  time(&exchange_rates_check_time[2]);                                         \
  time(&priv->exchange_rates_check_time2[0]);
...
bool Calculator::fetchExchangeRates(int timeout, int n) {
  ...
  if (datadir.substr(datadir.length() - 4) != "\\bin" &&
      datadir.substr(datadir.length() - 6) != "\\.libs") {
  ...
  if (res != CURLE_OK) {
    if (strlen(error_buffer)) {
      FER_ERROR("ecb.europa.eu", error_buffer, "", "");
    } else {
      FER_ERROR("ecb.europa.eu", curl_easy_strerror(res), "", "");
    }
    FETCH_FAIL_CLEANUP;
    return false;
  }
  if (sbuffer.find("Cube") == string::npos) {
    FER_ERROR("ecb.europa.eu", "Document empty", "", "");
    FETCH_FAIL_CLEANUP;
    return false;
  }
  ofstream file(getExchangeRatesFileName(1).c_str(),
  ...
  if (n <= 0 || n >= 2) {
    ...
    if (res != CURLE_OK) {
      if (strlen(error_buffer)) {
        FER_ERROR("coinbase.com", error_buffer, "ecb.europa.eu",
                  u_btc->title().c_str());
      } else {
        FER_ERROR("coinbase.com", curl_easy_strerror(res), "ecb.europa.eu",
                  u_btc->title().c_str());
      }
      FETCH_FAIL_CLEANUP;
      return false;
    }
    if (sbuffer.find("\"amount\":") == string::npos ||
        sbuffer.find("\"currency\":") == string::npos) {
      FER_ERROR("coinbase.com", "Document empty", "ecb.europa.eu",
                u_btc->title().c_str());
      FETCH_FAIL_CLEANUP;
      return false;
    }
    ofstream file3(getExchangeRatesFileName(2).c_str(),
                   ios::out | ios::trunc | ios::binary);
    if (!file3.is_open()) {
    ...
    for (size_t i = 0; i <= 2 || (bad_gateway && i == 3); i++) {
      ...
      if (i == 0)
        curl_easy_setopt(curl, CURLOPT_URL,
                         ...
                         "currency-api@1/latest/currencies/eur.json");
      else if (i == 2)
        curl_easy_setopt(curl, CURLOPT_URL,
                         "https://www.floatrates.com/daily/eur.json");
      else
        curl_easy_setopt(curl, CURLOPT_URL,
                         "https://www.mycurrency.net/FR.json");
      curl_easy_setopt(curl, CURLOPT_TIMEOUT, timeout);
      curl_easy_setopt(curl, CURLOPT_WRITEFUNCTION, write_data);
      curl_easy_setopt(curl, CURLOPT_WRITEDATA, &sbuffer);
      curl_easy_setopt(curl, CURLOPT_ERRORBUFFER, error_buffer);
      if (i == 3)
        curl_easy_setopt(curl, CURLOPT_USERAGENT,
                         (string("libqalculate/") + VERSION).c_str());

      res = curl_easy_perform(curl);

      if (res == CURLE_OK) {
        if ((i == 0 &&
             (sbuffer.find(": {") != string::npos ||
              sbuffer.find(":{") != string::npos) &&
             (sbuffer.find("\"eur\": 1,") != string::npos ||
              sbuffer.find("\"eur\":1,") != string::npos ||
              sbuffer.find("\"EUR\": 1,") != string::npos ||
              sbuffer.find("\"EUR\":1,") != string::npos)) ||
            ((i == 1 || i == 3) &&
             sbuffer.find("\"currency_code\":") != string::npos &&
             sbuffer.find("\"baseCurrency\":\"EUR\"") != string::npos) ||
            (i == 2 && sbuffer.find("\"alphaCode\":") != string::npos)) {
          if (i > 2)
            priv->exchange_rates_url3 = 1;
          else
            priv->exchange_rates_url3 = i;
          b = true;
          mycurrency_net = (i == 1 || i == 3);
          break;
        }
        if (i == 1 && sbuffer.find("Bad Gateway") != string::npos)
          bad_gateway = true;
        if (i == 0)
          first_error = "Document empty";
      } else if (i == 0) {
        if (strlen(error_buffer))
          first_error = error_buffer;
        else
          first_error = curl_easy_strerror(res);
      }
    }
    if (!b) {
      FER_ERROR("floatrates.com", first_error.c_str(),
                "ecb.europa.eu, coinbase.com", "");
      FETCH_FAIL_CLEANUP;
      return false;
    }
    ofstream file2(getExchangeRatesFileName(3).c_str(),
                   ios::out | ios::trunc | ios::binary);
    if (!file2.is_open()) {
      FER_ERROR("floatrates.com", strerror(errno),
                "ecb.europa.eu, coinbase.com", "");
      FETCH_FAIL_CLEANUP
      return false;
    }
  ...
  if (n >= 4 && mycurrency_net) {
    ...
    if (res != CURLE_OK) {
      if (strlen(error_buffer)) {
        FER_ERROR("nbrb.by", error_buffer,
                  "ecb.europa.eu, coinbase.com, mycurrency.net",
                  priv->u_byn->title().c_str());
      } else {
        FER_ERROR("nbrb.by", curl_easy_strerror(res),
                  "ecb.europa.eu, coinbase.com, mycurrency.net",
                  priv->u_byn->title().c_str());
      }
      FETCH_FAIL_CLEANUP;
    ...
    if (sbuffer.find("\"Cur_OfficialRate\":") == string::npos) {
      FER_ERROR("nbrb.by", "Document empty",
                "ecb.europa.eu, coinbase.com, mycurrency.net",
                priv->u_byn->title().c_str());
      FETCH_FAIL_CLEANUP;
      return false;
    }
    ofstream file4(getExchangeRatesFileName(4).c_str(),
                   ios::out | ios::trunc | ios::binary);
    if (!file4.is_open()) {
      FER_ERROR("nbrb.by", strerror(errno),
                "ecb.europa.eu, coinbase.com, mycurrency.net",
                priv->u_byn->title().c_str());
      FETCH_FAIL_CLEANUP
      return false;
...
bool Calculator::checkExchangeRatesDate(unsigned int n_days, bool force_check,
                                        bool send_warning, int n) {
  if (n <= 0)
    n = 5;
  time_t extime = exchange_rates_time[0];
  for (int i = 1; i < (n > 4 ? 4 : n); i++) {
    if (i > 2 && priv->exchange_rates_time2[i - 3] < extime)
      extime = priv->exchange_rates_time2[i - 3];
    else if (i <= 2 && (i != 2 || n != 4) && exchange_rates_time[i] < extime)
      extime = exchange_rates_time[i];
  }
  time_t cextime = exchange_rates_check_time[0];
  for (int i = 1; i < (n > 4 ? 4 : n); i++) {
    if (i > 2 && priv->exchange_rates_check_time2[i - 3] < cextime)
      cextime = priv->exchange_rates_check_time2[i - 3];
    else if (i <= 2 && (i != 2 || n != 4) &&
             exchange_rates_check_time[i] < cextime)
      cextime = exchange_rates_check_time[i];
  }
  if (extime > 0 && ((!force_check && cextime > 0 &&
                      difftime(time(NULL), cextime) < 86400 * n_days) ||
                     difftime(time(NULL), extime) < (86400 * n_days) + 3600))
    return true;
  for (int i = 0; i < (n > 4 ? 4 : n); i++) {
    if (i <= 2 && (i != 2 || n != 4))
      time(&exchange_rates_check_time[i]);
    else if (i > 2)
      time(&priv->exchange_rates_check_time2[i - 3]);
  }
...
int Calculator::exchangeRatesUsed() const {
  ...
  if (b_exchange_rates_used & 0b1000) {
    if (b_exchange_rates_used & 0b0100)
      return 5;
    return 4;
  } else if (b_exchange_rates_used & 0b0100)
    return 3;
  else if (b_exchange_rates_used & 0b0010)
    return 2;
  else if (b_exchange_rates_used & 0b0001)
    return 1;
  return 0;
}
void Calculator::resetExchangeRatesUsed() { b_exchange_rates_used = 0; }
void Calculator::setExchangeRatesUsed(int index) {
  if (index == -100) {
    if (b_exchange_rates_used == 0)
      return;
    if (b_exchange_rates_used > 100)
      b_exchange_rates_used -= 100;
    else
      b_exchange_rates_used += 100;
    return;
  }
  b_exchange_rates_used = b_exchange_rates_used | index;
  if (b_exchange_rates_warning_enabled)
    checkExchangeRatesDate(7, false, true, exchangeRatesUsed());
}
