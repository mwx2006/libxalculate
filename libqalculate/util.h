...
std::string &gsub(const std::string &pattern, const std::string &sub,
                  std::string &str);
...
size_t find_ending_bracket(const std::string &str, size_t start,
                           int *missing = NULL);
...
std::string sub_suffix(const std::string &name, const std::string &tag_begin,
                       const std::string &tag_end);
bool equalsIgnoreCase(const std::string &str1, const std::string &str2);
bool equalsIgnoreCase(const std::string &str1, const char *str2);

void parse_qalculate_version(std::string qalculate_version,
...
std::string buildPath(std::string dir1, std::string dir2, std::string dir3,
                      std::string filename);
...
int checkAvailableVersion(const char *version_id, const char *current_version,
                          std::string *available_version = NULL,
                          int timeout = 5);
